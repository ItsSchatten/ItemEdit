...
public enum ColorCodeConverter {
     ...
     * @param colorCode   The color code character.
     * @param replacement The String to replace the color code.
     * @param decoration  The actual {@link TextDecoration}
     */
    ...
    public static String getReplacementFromFormat(TextDecoration textDecoration) {
        return switch (textDecoration) {
            case OBFUSCATED -> OBFUSCATE.replacement;
            case BOLD -> BOLD.replacement;
            case STRIKETHROUGH -> STRIKETHROUGH.replacement;
            case UNDERLINED -> UNDERLINE.replacement;
            case ITALIC -> ITALIC.replacement;
        };
    }
}
